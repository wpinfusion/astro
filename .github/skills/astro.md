...
<Layout title="Homepage">
	<Section>
		<Container>
			...
			<p class="mt-4 text-lg">This is the main landing page of the website.</p>
		</Container>
	</Section>
</Layout>
```

Use the Section and Container components to structure the page, giving the contents a consistent spacing and alignment.
